...
Entry = namedtuple('Entry', 'datum rekening1 rekening2 naam_tegen adres postcode plaats valutasoort_rekening saldo valutasoort_mutatie transactiebedrag journaaldatum valutadatum intern globaal volgnummer betalingskenmerk omschrijving afschrifnummer')
...
def convert_entry(entry: Entry):
    ...
    return Convert(entry.datum, entry.naam_tegen, '', entry.omschrijving, outflow, inflow)
