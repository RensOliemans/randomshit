...
from general.outer_shell import Child
from wasmachine.sql import get_programme, insert_measurement, get_amount_measurements, get_averages, get_previous_end, \
    get_programmes
from wasmachine.data import Measurement


class Wasmachine(Child):
